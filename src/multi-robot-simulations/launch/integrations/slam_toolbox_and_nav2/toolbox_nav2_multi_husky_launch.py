...
def generate_launch_description(): 
    ...
    # husky spawn path
    husky_launch_path = os.path.join(project_dir, 'launch', 'integrations', 'slam_toolbox_and_nav2', 'toolbox_nav2_spawn_husky_launch.py')
    ...
    rviz_node = Node(
                        ...
                        namespace='',
                        parameters=[{'use_sim_time': True}],
                        arguments=["-d", os.path.join(project_dir,'config', 'integrations', 'slam_toolbox_and_nav2', 'all_robots.rviz')],
